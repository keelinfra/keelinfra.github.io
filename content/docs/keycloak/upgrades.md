+++
title = "Upgrades"
description = "Supported upgrade paths, strategies, and measured service windows — every path is executed end-to-end before it is listed, and re-proven nightly in CI."
weight = 5
[extra]
...
<!-- GENERATED from keelinfra/keycloak@8fe72c9 (UPGRADES.md) by scripts/sync_docs.py — edit it THERE, not here. -->
