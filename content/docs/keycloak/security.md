...
description = "How to report vulnerabilities privately, what is in scope, and how upstream CVEs are handled."
weight = 7
[extra]
...
<!-- GENERATED from keelinfra/keycloak@f987cb1 (SECURITY.md) by scripts/sync_docs.py — edit it THERE, not here. -->
